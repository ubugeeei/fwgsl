; Zed highlight queries for shadml
; These are shared with the tree-sitter-shadml grammar.
; See ../../tree-sitter-shadml/queries/highlights.scm for the canonical version.
