// External scanner for fwgsl tree-sitter grammar.
//
...
void *tree_sitter_fwgsl_external_scanner_create(void) { return NULL; }
void tree_sitter_fwgsl_external_scanner_destroy(void *p) {}
unsigned tree_sitter_fwgsl_external_scanner_serialize(void *p, char *b) {
  return 0;
}
void tree_sitter_fwgsl_external_scanner_deserialize(void *p, const char *b,
                                                     unsigned n) {}
...
bool tree_sitter_fwgsl_external_scanner_scan(void *payload, TSLexer *lexer,
